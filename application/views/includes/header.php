...
<head>
	...
	<style>
		...
		.cats{padding: 5px 0 0 5px}
		.proBox{width: 19%; position:relative; overflow: hidden; box-sizing: border-box; border:1px solid #ddd; border-radius: 5px; margin: 5px;  float:left; cursor: pointer;}
		.catBox{width: 19%; position:relative; overflow: hidden; box-sizing: border-box; border:1px solid #ddd; border-radius: 5px; margin: 5px;  float:left; cursor: pointer;}
		.proName{font-size: 12px; position: absolute; bottom: 0;left: 0;right: 0; padding: 5px; background: rgba(0,0,0,0.5); color: #fff;}
		.catName{font-size: 17px;position: relative; font-weight: bold; text-align: center; bottom: 0; left: 0; right: 0; padding: 5px; background: rgba(204, 89, 45, 1); color: #fff;}
	</style>
</head>
<body>